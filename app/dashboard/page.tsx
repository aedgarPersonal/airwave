        ...
        {stations.length === 0 ? (
          <div className="mt-12 rounded-2xl border border-line bg-bg-2 p-10 text-center">
            ...
            <p className="mt-2 text-muted">
              Import your existing station, start from scratch, or claim a
              seeded station you were invited to.
            </p>
            <div className="mt-6 flex items-center justify-center gap-3 flex-wrap">
              ...
              <Link
                ...
                className="rounded-full border border-line px-5 py-2.5 font-medium hover:bg-bg-3 transition"
              >
                Start from scratch
              </Link>
              <Link
